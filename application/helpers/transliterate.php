...
class transliterate_Core {
	public static function render($st, $level=0){
		...
		$cyr = array("а","б","в","г","д","е","ж","з","і","и","й","к","л","м","н","о","п","р","с","т","у","ф","ы","э","А","Б","В","Г","Д","Е","Ж","З","И","Й","К","Л","М","Н","О","П","Р","С","Т","У","Ф","Ы","Э");
		$eng = array("a","b","v","g","d","e","g","z","i","i","y","k","l","m","n","o","p","r","s","t","u","f","i","e","A","B","V","G","D","E","G","Z","I","Y","K","L","M","N","O","P","R","S","T","U","F","I","E");
