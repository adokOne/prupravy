...
class Recepts_Admin extends Constructor
{
    protected $item_table   = 'recips';
    ...
    private $lang = "ru";
    protected $logo_path = 'upload/recepies/';
    protected $logo_ext = '.jpg';
    protected $logo_prefix = '/rec_big';
    ...
    public function __construct()
    {
        ...
        {
            if($field == "name" || $field == "consist" || $field == "prepare")
