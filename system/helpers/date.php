...
class date_Core {
	...
	// Возвращает дату на основе числа секунд, прошедших с 1 Янв 1970. Аналог date()
	public static function rusdate($format,$tm=-1){
		$DateNamesSet = array();	
		$DateNamesSet =array("January"=>"Январь", "February"=>"Февраль", "March"=>"Март", "April"=>"Апрель", "May"=>"Май", "June"=>"Июнь", "July"=>"Июль", "August"=>"Август", "September"=>"Сентябрь", "October"=>"Октябрь", "November"=>"Ноябрь", "December"=>"Декабрь");
	...
	public static function rusdate2($format,$tm=-1){
		$DateNamesSet = array();	
    ...
    // Возвращает год в правильном формате, в зависимости от возраста
    public static function rusage($years){
        if($years < 20){
            if($years == 1){
                return($years." год");
            ...
            $lastDigit = intval(substr($years, -1));
