 ...
 */
$config['site_domain'] = 'prupravy.local';
 ...
 */
$config['extension_prefix'] = 'BTECH_';
...
$config['sitename']     = 'biluk.local';
$config['site_email']   = 'info@biluk.local';
$config['default_lang'] = 0;
$config["site_contact_email"] = 'info@biluk.org';
$config["default_city_id"] = 2;
